...
export const products: Product[] = [
  ...
  },
  {
    ...
    desc: 'Nightlife-ready energy. Bold cranberry punch meets a refreshing mojito finish, engineered for those who own the night. Perfect for late gaming sessions, nightlife, and after-dark performance.',
    specs: [
      { label: 'Volume', val: '250 ML' },
      { label: 'Caffeine', val: '80 MG' },
      { label: 'Flavour', val: 'Cranberry Mojito' },
