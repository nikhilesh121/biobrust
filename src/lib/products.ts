...
export const products: Product[] = [
  ...
  },
  {
    id: 'cranberry',
    name: 'Cranberry',
    tag: 'Energy · Night Series',
    series: 'Night Edition',
    usecase: 'Night Mode',
    usecaseColor: '#e8006a',
    usecaseBg: 'rgba(208,0,74,0.15)',
    usecaseBorder: 'rgba(208,0,74,0.3)',
    desc: 'Nightlife-ready energy. Bold cranberry punch engineered for those who own the night. Perfect for late gaming sessions, nightlife, and after-dark performance.',
    specs: [
      { label: 'Volume', val: '250 ML' },
      { label: 'Caffeine', val: '80 MG' },
      { label: 'Flavour', val: 'Cranberry' },
      { label: 'Best For', val: 'Nightlife' },
    ],
    color: '#e8006a',
  ...
  },
  {
    ...
    desc: 'Crisp, clean, and perfectly balanced. BIOBRUST Tonic Water delivers a light but effective energy boost with a sophisticated quinine-kissed profile. For the refined warrior who appreciates subtlety.',
    specs: [
      { label: 'Volume', val: '250 ML' },
      { label: 'Caffeine', val: '60 MG' },
  ...
  },
  {
    ...
    desc: 'The ultimate party fuel. BIOBRUST Virjit Mojito blends a zesty lime-mint mojito burst with precision-dosed energy — engineered for those who dominate every social scene and never slow down.',
    specs: [
      { label: 'Volume', val: '250 ML' },
      { label: 'Caffeine', val: '80 MG' },
      { label: 'Flavour', val: 'Virjit Mojito' },
